...
import { imgSection } from "./svg-29zlf";
...
function Frame4() {
  return (
    <div className="absolute content-center flex flex-wrap gap-[0px_47.763px] items-center justify-center left-[28.75px] top-[155.23px]">
      <Frame1 />
      <Frame3 />
      <Frame2 />
      ...
      <Frame3 />
      <Frame2 />
      <div className="h-[48.97px] relative shrink-0 w-[223.087px]" data-name="image 186">
        <div className="absolute inset-0 overflow-hidden pointer-events-none">
          <img alt="" className="absolute h-[138.89%] left-[-3.18%] max-w-none top-[-19.44%] w-[106.97%]" src={imgImage176} />
        </div>
      </div>
      <div className="h-[50px] relative shrink-0 w-[148px]" data-name="image 187">
        <div className="absolute inset-0 overflow-hidden pointer-events-none">
          <img alt="" className="absolute h-[166.87%] left-0 max-w-none top-[-33.44%] w-full" src={imgImage185} />
        </div>
      </div>
      <div className="h-[47.083px] relative shrink-0 w-[169.449px]" data-name="image 188">
        <img alt="" className="absolute inset-0 max-w-none object-50%-50% object-cover pointer-events-none size-full" src={imgImage181} />
      </div>
      <div className="h-[47.118px] relative shrink-0 w-[154.272px]" data-name="image 189">
        <img alt="" className="absolute inset-0 max-w-none object-50%-50% object-cover pointer-events-none size-full" src={imgImage179} />
      </div>
      <div className="h-[47.057px] relative shrink-0 w-[144.111px]" data-name="image 190">
        <div className="absolute inset-0 overflow-hidden pointer-events-none">
          <img alt="" className="absolute h-[162.04%] left-[-9.85%] max-w-none top-[-32.32%] w-[119.49%]" src={imgImage191} />
        </div>
      </div>
...
export default function Frame() {
  return (
    <div className="content-stretch flex flex-col gap-[32px] items-center justify-center px-[51px] py-0 relative size-full">
