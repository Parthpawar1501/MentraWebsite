import svgPaths from "./svg-druisifc63";
...
export default function IPhone() {
  return (
    <div className="bg-white content-stretch flex flex-col items-center relative size-full" data-name="iPhone 13 & 14 - 1">
      <Frame />
      <div className="absolute bottom-0 h-[107px] left-1/2 pointer-events-none top-[737px]">
        <DivGrid2 />
      </div>
      <div className="absolute bottom-0 h-[844px] left-1/2 pointer-events-none top-0">
        <DivGrid3 />
      </div>
      <Frame8 />
    </div>
