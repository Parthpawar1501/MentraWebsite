import svgPaths from "./svg-q5a2i2c60d";
...
function ProductImages() {
  return (
    <div className="relative rounded-[40px] shrink-0 w-full" data-name="ProductImages">
    ...
    <div className="relative shrink-0 size-[24px]" data-name="Navigation Icon">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 24 24">
        <g id="Navigation Icon">
          <path d="M5 12H19" id="Vector" stroke="var(--stroke-0, #0A0A0A)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" />
        </g>
      </svg>
    </div>
  );
...
function Frame20() {
  return (
    <div className="basis-0 content-stretch flex flex-col gap-[32px] grow items-start min-h-px min-w-px relative shrink-0">
      <div className="aspect-[468/260] relative rounded-[32px] shrink-0 w-full" data-name="Screenshot 2025-12-05 at 2.41.28 PM 1">
...
function Frame62() {
  return (
    <div className="content-stretch flex flex-col gap-[16px] items-start not-italic relative shrink-0 w-full">
      <p className="font-['Red_Hat_Display:SemiBold',sans-serif] leading-[40px] relative shrink-0 text-[#0d0c0d] text-[24px] tracking-[0.3px] w-full">Audio</p>
      <div className="flex flex-col font-['Red_Hat_Display:Medium',sans-serif] justify-center leading-[0] relative shrink-0 text-[#686069] text-[16px] tracking-[-0.2px] w-full">
        <p className="leading-[1.5]">
          Glasses
          <br aria-hidden="true" />
...
function Frame63() {
  return (
    <div className="basis-0 content-stretch flex flex-col gap-[16px] grow items-start min-h-px min-w-px not-italic relative shrink-0">
      <p className="font-['Red_Hat_Display:SemiBold',sans-serif] leading-[40px] relative shrink-0 text-[#0d0c0d] text-[24px] tracking-[0.3px] w-full">Battery</p>
      <div className="flex flex-col font-['Red_Hat_Display:Medium',sans-serif] justify-center leading-[0] relative shrink-0 text-[#686069] text-[16px] tracking-[-0.2px] w-full">
        <p className="leading-[1.5]">
          Glasses
          <br aria-hidden="true" />
...
function Frame65() {
  return (
    <div className="basis-0 content-stretch flex flex-col gap-[16px] grow items-start min-h-px min-w-px not-italic relative shrink-0">
      <p className="font-['Red_Hat_Display:SemiBold',sans-serif] leading-[40px] relative shrink-0 text-[#0d0c0d] text-[24px] tracking-[0.3px] w-full">Connectivity</p>
      <div className="flex flex-col font-['Red_Hat_Display:Medium',sans-serif] justify-center leading-[0] relative shrink-0 text-[#686069] text-[16px] tracking-[-0.2px] w-full">
        <p className="leading-[1.5]">
          Glasses
          <br aria-hidden="true" />
...
function Frame30() {
  return (
    <div className="basis-0 bg-[#f5f5f5] content-stretch flex flex-col grow items-center justify-center min-h-px min-w-px overflow-clip px-0 py-[40px] relative rounded-[32px] shrink-0">
      <div className="aspect-[710/466.475] relative shrink-0 w-full" data-name="image 137">
        <div className="absolute inset-0 overflow-hidden pointer-events-none">
          <img alt="" className="absolute h-[152.21%] left-0 max-w-none top-[-27.38%] w-full" src={imgImage137} />
        </div>
      </div>
      <Frame39 />
    </div>
...
function Group4() {
  return (
    <div className="grid-cols-[max-content] grid-rows-[max-content] inline-grid leading-[0] place-items-start relative shrink-0">
      <p className="[grid-area:1_/_1] font-['Red_Hat_Display:Bold',sans-serif] leading-[1.25] ml-[379.5px] mt-0 not-italic relative text-[64px] text-black text-center text-nowrap translate-x-[-50%]">AI runs on context.</p>
      <p className="[grid-area:1_/_1] font-['Red_Hat_Display:Regular',sans-serif] leading-[1.25] ml-[379.5px] mt-[94px] not-italic relative text-[48px] text-black text-center text-nowrap translate-x-[-50%]">Smart glasses capture it all... you in?</p>
...
function Footer() {
  return (
    <div className="content-stretch flex items-start px-0 py-[48px] relative shrink-0 w-full" data-name="Footer">
  ...
  return (
    <div className="relative shrink-0 w-full">
      <div className="flex flex-col items-center justify-center overflow-clip rounded-[inherit] size-full">
        <div className="content-stretch flex flex-col gap-[160px] items-center justify-center px-[133.778px] py-[144px] relative w-full">
          <Frame5 />
          <Footer />
        </div>
      </div>
...
export default function MentraLive() {
  return (
    <div className="bg-white content-stretch flex flex-col items-start relative size-full" data-name="Mentra Live">
      <Frame38 />
      <Frame8 />
      <div className="absolute bottom-0 h-[-0.003574218750145519px] left-0 pointer-events-none top-[7144.84px]">
        <NavBar />
      </div>
    </div>
  );
